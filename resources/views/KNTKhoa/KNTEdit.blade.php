                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" class="form-control" aria-describedby="KNTMaKH" name="KNTMaKH" value=" {{ $KNTkhoa->KNTMaKH }}" readonly>
                        </div>
                        <div class="input-group input-group-sm mb-3">
                            <span class="input-group-text" id="TenKH">Tên khoa</span>
                            <input type="text" class="form-control" aria-describedby="KNTTenKH" name="KNTTenKH" value="{{ $KNTkhoa->KNTTenKH }}">
                        </div>
