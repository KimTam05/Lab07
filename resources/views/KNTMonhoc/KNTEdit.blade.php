            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" name="KNTMaMH" value="{{$KNTEdit->KNTMaMH}}" readonly>
                    </div>
                    @error('KNTMaMH')
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" class="form-control" name="KNTTenMH" value="{{$KNTEdit->KNTTenMH}}">
                    </div>
                    @error('KNTTenMH')
                        <span class="text-danger"> {{ $message }} </span>    
                    @enderror
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="number" class="form-control" name="KNTSotiet" value="{{$KNTEdit->KNTSotiet}}">
                    </div>
                    @error('KNTSotiet')
                        <span class="text-danger"> {{ $message }} </span>    
                    @enderror
